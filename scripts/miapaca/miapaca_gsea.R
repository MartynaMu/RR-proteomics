...
compute_gsea(fit = fit_bayes, path = "figures/miapaca/int_mat_fc/", GO = "MF", coefs = coefs, plot = TRUE)
...
compute_keggsea(fit = fit_bayes, path = "figures/miapaca/int_mat_fc/", coefs = coefs)

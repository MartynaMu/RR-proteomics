...
mat %>% filter(rownames(mat) %in% filtr) |>
  pheatmap::pheatmap(annotation_col = annot_col,
                   annotation_colors = annot_colors,
                   annotation_names_col = FALSE,
                   show_rownames = FALSE,
                   main = "DEPs of log2FC cut-off = |1.3|")
...
annotate_figure(plot, top=text_grob("DEPs, log2FC cut-off = |1.3|", size = 15))
